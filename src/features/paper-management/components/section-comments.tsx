  ...
  return (
    <div className="mt-4 flex flex-col gap-4 border-t border-slate-100 pt-4 dark:border-slate-800">
      <div className="flex items-center gap-2 text-sm font-semibold text-slate-800 dark:text-slate-200">
        ...
        Peer Review & Feedback {comments.length > 0 && <span className="text-slate-500">({comments.length})</span>}
      </div>
      ...
      {/* Composer Input */}
      {!isReadOnly && (
        <div className="mt-2 flex flex-col gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3 shadow-sm dark:border-slate-700 dark:bg-slate-800/40">
          <Input
